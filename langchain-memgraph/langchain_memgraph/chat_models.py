...
class ChatMemgraph(BaseChatModel):
    ...
    """Memgraph chat model integration.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            Memgraph API key. If not passed in will be read from env var MEMGRAPH_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatMemgraph.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatMemgraph.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatMemgraph supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatMemgraph supports async generation. Otherwise delete.
